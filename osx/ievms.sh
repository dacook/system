#!/usr/bin/env bash
#dcook 2013-12-09: added parameter for which IEVMs to build [optional; default "6 7 8 9 10"]
#   and second parameter to force: "f"
$force = $2
...
download_unar() {
    unar_url="http://mlb-fs01.mlb.squiz.net.au/unar1.5.zip"
...
build_ievm() {
    ...
    url="http://mlb-fs01.mlb.squiz.net.au/${archive}"
...
build_ievm_xp() {
    ...
    iso_url="http://mlb-fs01.mlb.squiz.net.au/ievms-control.iso"
...
build_ievm_ie7() {
    ...
    build_ievm_xp 7 "http://mlb-fs01.mlb.squiz.net.au/IE7-WindowsXP-x86-enu.exe"
}

build_ievm_ie8() {
    if [ "${reuse_xp}" != "yes" ]; then return; fi
    build_ievm_xp 8 "http://mlb-fs01.mlb.squiz.net.au/IE8-WindowsXP-x86-ENU.exe"
}
...
log "Creating IEVMS Group..."

VBoxManage modifyvm "IE6 - WinXP" --groups "/IEVMS"
VBoxManage modifyvm "IE7 - WinXP" --groups "/IEVMS"
VBoxManage modifyvm "IE8 - WinXP" --groups "/IEVMS"
VBoxManage modifyvm "IE9 - Win7" --groups "/IEVMS"
VBoxManage modifyvm "IE10 - Win8" --groups "/IEVMS"
